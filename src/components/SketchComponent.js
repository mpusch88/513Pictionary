                ...
                <div style={{
                    ...
                    <div
                        ...
                        <button
                            ...
                            ? 'item-active'
                            : 'item'}
                            onClick={() => this.setState({tool: TOOL_PENCIL, color: this.state.preColor})}>Pencil</button>
                        <button
                            ...
                            ? 'item-active'
                            : 'item'}
                            onClick={() => this.setState({tool: TOOL_LINE, color: this.state.preColor})}>Line</button>
                        <button
                            ...
                            ? 'item-active'
                            : 'item'}
                            onClick={() => this.setState({tool: TOOL_ELLIPSE, color: this.state.preColor})}>Ellipse</button>
                        <button
                            ...
                            ? 'item-active'
                            : 'item'}
                            onClick={() => this.setState({tool: TOOL_RECTANGLE, color: this.state.preColor})}>Rectangle</button>
                    </div>
                    <div
                        className="options"
                        style={{
